...
$foto_desa = !empty($desa->foto) ? $desa->foto : 'https://images.unsplash.com/photo-1500382017468-9049fed747ef?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80';
?>
            ...
            <div class="flex flex-col md:flex-row items-end justify-between gap-6">
                <div class="max-w-4xl w-full">
                    ...
                    <div class="flex flex-wrap items-center gap-3 mb-4">
                        <span class="bg-primary/90 backdrop-blur-md text-white border border-white/20 text-xs font-bold px-3 py-1.5 rounded-full flex items-center gap-2 shadow-lg">
                    ...
                    <p class="text-gray-200 text-sm md:text-lg mb-0 font-light flex flex-wrap items-center gap-2 md:gap-4 drop-shadow-md">
                        ...
                        <span class="font-mono text-xs md:text-sm text-primary-light bg-primary/10 px-2 py-0.5 rounded border border-primary/20">@<?php echo esc_html($desa->slug_desa); ?></span>
                    </p>
                </div>
...
<!-- === MAIN CONTENT === -->
<div class="bg-gray-50 min-h-screen py-8 md:py-12 relative">
            ...
            <div class="w-full lg:w-3/4 space-y-10">
                ...
                <div id="wisata" class="scroll-mt-28">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        ?>
                        <a href="<?php echo esc_url($link_w); ?>" class="group bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100 hover:shadow-xl hover:border-primary/20 hover:-translate-y-1 transition duration-300 flex flex-col h-full">
                            <div class="relative h-52 overflow-hidden">
                                ...
                                <div class="absolute bottom-4 left-4 right-4">
                                    <h3 class="font-bold text-white text-lg leading-tight group-hover:text-primary-light transition line-clamp-1"><?php echo esc_html($w->nama_wisata); ?></h3>
                            ...
                            <div class="p-5 flex flex-col flex-1">
                                ...
                                <div class="mt-auto pt-4 border-t border-gray-50 flex justify-between items-center">
                                    ...
                                    <span class="w-8 h-8 rounded-full bg-gray-50 flex items-center justify-center text-gray-400 group-hover:bg-primary group-hover:text-white transition shadow-sm">
                ...
                <div id="umkm" class="scroll-mt-28">
                    <div class="flex items-center justify-between mb-6">
                        <h2 class="text-2xl font-bold text-gray-900 flex items-center gap-3">
                            <span class="w-1 h-8 bg-orange-500 rounded-full block"></span>
                            UMKM & Produk Lokal
                        </h2>
                    </div>
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
                        ...
                        ?>
                        <a href="<?php echo esc_url($link_p); ?>" class="group bg-white rounded-xl border border-gray-100 p-5 hover:shadow-lg hover:border-primary/20 hover:-translate-y-1 transition duration-300 flex flex-col items-center text-center">
                            <div class="w-20 h-20 md:w-24 md:h-24 mb-4 relative">
                                <div class="w-full h-full rounded-full p-1 border-2 border-gray-100 group-hover:border-primary transition overflow-hidden">
                            ...
                            <h4 class="font-bold text-gray-800 text-sm md:text-base leading-tight group-hover:text-primary transition mb-1 line-clamp-1"><?php echo esc_html($p->nama_toko); ?></h4>
                            <p class="text-xs text-gray-500 mb-4 line-clamp-1">Owner: <?php echo esc_html($p->nama_pemilik); ?></p>
                            
                            <span class="mt-auto inline-flex items-center gap-1 text-[10px] md:text-xs font-bold bg-gray-50 text-gray-500 px-4 py-2 rounded-full group-hover:bg-primary group-hover:text-white transition w-full justify-center">
            ...
            <div class="w-full lg:w-1/4">
                <div class="sticky top-24 space-y-6">
                    ...
                    <div class="bg-white rounded-2xl shadow-xl shadow-gray-100 border border-gray-100 overflow-hidden">
                        <div class="bg-gradient-to-r from-primary to-green-500 p-4">
                        ...
                        <div class="p-6 space-y-5">
                            ...
                            <div class="flex gap-3">
                                ...
                                <div class="w-full">
                                    ...
                                    <div class="bg-gray-50 p-3 rounded-xl border border-gray-200 group hover:border-primary/50 transition">
                                        ...
                                        <div class="font-mono font-bold text-gray-800 text-sm tracking-wide mb-1 select-all cursor-pointer group-hover:text-primary transition" title="Klik untuk menyalin" onclick="navigator.clipboard.writeText(this.innerText); alert('Nomor rekening disalin!');">
                    ...
                    <div class="bg-blue-50 p-5 rounded-2xl text-center border border-blue-100 shadow-sm">
                        ...
                        <div class="flex justify-center gap-3">
                             <a href="https://wa.me/?text=Lihat%20Profil%20Desa%20<?php echo urlencode($desa->nama_desa); ?>%20di%20<?php echo urlencode(get_permalink()); ?>" target="_blank" class="w-10 h-10 rounded-full bg-green-500 text-white flex items-center justify-center hover:bg-green-600 hover:scale-110 transition shadow-lg shadow-green-200"><i class="fab fa-whatsapp text-lg"></i></a>
                             <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo urlencode(get_permalink()); ?>" target="_blank" class="w-10 h-10 rounded-full bg-blue-600 text-white flex items-center justify-center hover:bg-blue-700 hover:scale-110 transition shadow-lg shadow-blue-200"><i class="fab fa-facebook-f text-lg"></i></a>
                             <button onclick="navigator.clipboard.writeText(window.location.href); alert('Link disalin!');" class="w-10 h-10 rounded-full bg-white text-gray-600 flex items-center justify-center hover:bg-gray-100 hover:text-primary hover:scale-110 transition shadow-lg shadow-gray-200 border border-gray-100"><i class="fas fa-link text-lg"></i></button>
                        </div>
                    </div>

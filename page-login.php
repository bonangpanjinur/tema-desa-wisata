 ...
 * Description: Login page with role-based redirection & Village Registration Info.
 */
    ...
    <div class="max-w-md w-full space-y-8 relative z-10">
        ...
        <div class="bg-white p-8 rounded-2xl shadow-xl border border-gray-100">
            ...
            <?php if ( !empty($error_message) ) : ?>
                <div class="bg-red-50 border-l-4 border-red-500 p-4 rounded-md mt-4">
                    <div class="flex">
            ...
            <div class="mt-6 text-center">
                <p class="text-sm text-gray-600">
                    Belum punya akun Pembeli/Pedagang? 
        ...
        <!-- NEW: BAGIAN DAFTAR DESA (KHUSUS) -->
        <div class="bg-blue-50 border border-blue-200 p-6 rounded-2xl shadow-sm text-center">
            <h3 class="font-bold text-blue-900 text-lg mb-2">Ingin Mendaftarkan Desa Wisata?</h3>
            <p class="text-sm text-blue-700 mb-4">
                Pendaftaran Desa Wisata memerlukan verifikasi khusus. Silakan hubungi Admin Kabupaten untuk mendapatkan akses pendaftaran.
            </p>
            <a href="https://wa.me/<?php echo $admin_wa; ?>?text=<?php echo $pesan_wa; ?>" target="_blank" class="inline-flex items-center justify-center px-5 py-2.5 bg-green-600 text-white font-bold rounded-lg hover:bg-green-700 transition shadow-md hover:shadow-lg transform hover:-translate-y-0.5">

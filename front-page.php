...
<div class="mt-4 px-0 md:px-0">
    ...
    <div class="flex md:grid md:grid-cols-2 overflow-x-auto gap-4 no-scrollbar snap-x md:snap-none pb-4 md:pb-0">
        ...
        <!-- Banner 1 -->
        <div class="min-w-[90%] md:min-w-0 h-48 md:h-80 bg-gradient-to-r from-blue-600 to-cyan-500 rounded-2xl relative snap-center shadow-lg overflow-hidden group">
            <img src="https://images.unsplash.com/photo-1501785888041-af3ef285b470?ixlib=rb-1.2.1&auto=format&fit=crop&w=1200&q=80" class="absolute inset-0 w-full h-full object-cover mix-blend-overlay opacity-50 group-hover:scale-105 transition duration-700">
            <div class="absolute bottom-6 left-6 text-white max-w-xs">
                <span class="text-xs font-bold bg-orange-500 px-3 py-1 rounded-full mb-3 inline-block">Promo Spesial</span>
                <h2 class="font-bold text-2xl md:text-4xl mb-2">Jelajah Alam Desa</h2>
                <p class="text-sm md:text-base opacity-90 mb-4">Nikmati diskon 20% untuk paket camping keluarga minggu ini.</p>
                <button class="bg-white text-blue-600 px-4 py-2 rounded-lg text-sm font-bold hover:bg-gray-100 transition">Lihat Promo</button>
            </div>
        </div>

        <!-- Banner 2 (Hidden on small mobile if needed, or scrolled) -->
        <div class="min-w-[90%] md:min-w-0 h-48 md:h-80 bg-gradient-to-r from-emerald-600 to-green-500 rounded-2xl relative snap-center shadow-lg overflow-hidden group">
             <img src="https://images.unsplash.com/photo-1596423736798-75b43694f540?ixlib=rb-1.2.1&auto=format&fit=crop&w=1200&q=80" class="absolute inset-0 w-full h-full object-cover mix-blend-overlay opacity-50 group-hover:scale-105 transition duration-700">
            <div class="absolute bottom-6 left-6 text-white max-w-xs">
                <span class="text-xs font-bold bg-blue-500 px-3 py-1 rounded-full mb-3 inline-block">Produk Unggulan</span>
                <h2 class="font-bold text-2xl md:text-4xl mb-2">Kerajinan Bambu</h2>
                <p class="text-sm md:text-base opacity-90 mb-4">Karya otentik pengrajin lokal dengan kualitas ekspor.</p>
                <button class="bg-white text-emerald-600 px-4 py-2 rounded-lg text-sm font-bold hover:bg-gray-100 transition">Belanja Sekarang</button>
            </div>
        </div>
